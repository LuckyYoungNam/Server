...
public enum ErrorCode {
    ...
    NOT_FOUND_POST(HttpStatus.NOT_FOUND,"찾을 수 없는 홍보 글입니다."),
    NOT_FOUND_IMAGE(HttpStatus.NOT_FOUND,"찾을 수 없는 홍보 사진입니다."),

    UNAUTHORIZED_POST(HttpStatus.UNAUTHORIZED, "홍보 글 접근 권한이 없습니다."),
    UNAUTHORIZED_IMAGE(HttpStatus.UNAUTHORIZED, "홍보 사진 접근 권한이 없습니다."),
